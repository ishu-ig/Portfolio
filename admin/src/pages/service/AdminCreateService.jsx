...
import { createService, getService } from "../../Redux/ActionCreartors/ServiceActionCreators"
...
export default function AdminCreateService() {
    ...
    let [error, setError] = useState({
        name: "Service Name Is Mendatory",
        shortDescription: "Short Description Is Mendatory",
        category: "Category Is Mendatory",
        price: "Price Is Mendatory",
        duration: "Duration Is Mendatory",
        icon: "Icon Is Mendatory",
        technology: "Technology Is Mendatory",
    })
    ...
    function postSubmit(e) {
        ...
        if (errorItem)
            ...
            let item = ServiceStateData.find(x => x.name.toLocaleLowerCase() === data.name.toLocaleLowerCase())  // in case of real backend
            ...
            if (item) {
                ...
                dispatch(createService({
                    ...data,
                    longDescription: rte.getHTMLCode()
                }));
    ...
    return (
        <>
            <div className="container">
                <h5 className="text-center text-light bg-primary p-2">Create Service <Link to="/Service"><i className="fa fa-arrow-left text-light float-end pt-1"></i></Link></h5>
                {/* Form */}
                <div className="card mt-3 shadow-sm p-4">
                    <form onSubmit={postSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea name="shortDescription" value={data.shortDescription} onChange={getInputData} className={`form-control border-3 ${show && error.shortDescription ? 'border-danger' : 'border-primary'}`} placeholder='Message...' rows={5}></textarea>
