        ...
        <footer id="footer" className="footer py-4">
            <div className="container text-center">
                ...
                <p className="copyright mb-2">
                    © <span>Copyright</span> <strong className="sitename px-1">PortFolio</strong> <span>All Rights Reserved</span>
                </p>
                ...
                <div className="social-links d-flex justify-content-center gap-3">
                    ...
                    <a href="https://www.instagram.com/_ishaan_12?igsh=MW9kNHhmaXFtbG0zeg==" target="_blank" className="social-icon"><i className="bi bi-instagram"></i></a>
                ...
                <p className="credits mt-2">
                    Designed by <a href="https://bootstrapmade.com/">Ishaan Gupta</a>
                </p>
            </div>
        </footer>
    );
